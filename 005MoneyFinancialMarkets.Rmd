...
The main interest rate the Fed controls is the **Federal Funds Rate**, which is the rate that banks charge each other on overnight loans to maintain their reserve ratio. 

The graph on the right shows the history of the Federal Funds rate since 1955; the Federal Funds market came into existence in the 1920s, but the Fed only collected data on it starting in mid-1954.

Most central banks have a similar type of interest rate. 
...
As the graph shows, the Fed usually reduces interest rates to stave off recessions.
...
fedfunds %>% 
    ...
    scale_y_continuous(labels = scales::percent_format(accuracy = 2),
                       ...
                       breaks = seq(-.2,3, by = .02),
                       limits = c(NA,NA)) +
    scale_x_date(limits = as.Date(c("2019-01-01", Sys.Date())),
        expand = c(0,0),   
...
The action of the Fed Funds rate surrounding Covid is illustrative of the Fed's general approach to monetary policy:

* They responded to the initial economic downturn by cutting interest rates -- here to basically zero
* As the economy recovered and inflation started to accelerate, they raised interest rates to try and slow it down.
