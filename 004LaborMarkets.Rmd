...
- These jobs are destroyed becasue of the appearance of new jobs in areas like IT server technician and automotive engineer.
...
- If Kaitz<40%, the general consensus is that the minimum wage is too low to have a noticeable unemployemnt effect.
