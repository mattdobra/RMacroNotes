...
Prior to WWWI, government spending accounted for about 7% of GDP.
...
#     mutate(date = as.Date(date)) %>% 
 ggplot() +
    ...
    labs(
        ...
        subtitle = "Consumption plus transfers as a share of GDP",
        x = "Year",
...
<!-- ## Institutions CODE IS BROKEN BECAUSE DATAHUB.IO IS DEAD?--> 
