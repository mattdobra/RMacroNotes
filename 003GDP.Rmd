...
ggplot() +
    ...
    geom_rect(data = recession.df, aes(xmin = start, xmax = end, ymin = -Inf, ymax = +Inf), fill = color5, alpha = .3) +
    scale_x_date(
        limits = as.Date(c("2019-01-01", Sys.Date())),
        labels = date_format("%Y"),
        breaks = function(x)
            seq.Date(
    ...
    theme_classic()+
    labs(
        title = "US GDP and GDI Diverge in the Short Run",
        subtitle = "Quarterly data since 2019",
        x = "Year",
        y = "Billions of 2012 Dollars",
        caption = "Data from U.S. BEA, Retrieved from FRED
        @mattdobra"
...
<center>
```{r out.width = "95%"}
knitr::include_graphics("images/CPI2022.jpg")
```
</center>
